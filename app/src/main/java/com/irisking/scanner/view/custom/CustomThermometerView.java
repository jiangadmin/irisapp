...
public class CustomThermometerView extends View {
...
//    private int mScaleMercuryLength;
    ...
    public CustomThermometerView(Context context) {
        this(context, null);
    }

    public CustomThermometerView(Context context, AttributeSet attrs) {
        super(context, attrs);
